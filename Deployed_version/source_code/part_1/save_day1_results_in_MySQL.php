...
for ($i=0; $i < count($trials) ; $i++) {
	...
	$stmt = $bdd->prepare('INSERT INTO results_day1_on_table (rt, key_press, trial_type, trial_index, time_elapsed, internal_node_id, subject, birthday, country, gender, screen_width, screen_height, stimulus, sequence_id, video_id, target1_or_filler0, firstoccurrence1_or_secondoccurrence2, video_position, url_name, correct) VALUES (:rt, :key_press, :trial_type, :trial_index, :time_elapsed, :internal_node_id, :subject, :birthday, :country, :gender, :screen_width, :screen_height, :stimulus, :sequence_id, :video_id, :target1_or_filler0, :firstoccurrence1_or_secondoccurrence2, :video_position, :url_name, :correct)');
	...
	$stmt->bindParam(':sequence_id', $to_insert[sequence_id]);
